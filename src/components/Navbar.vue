  ...
  <div class="bg-white">
    ...
    <header class="relative bg-white">
      <div class="top-header-flex">
        <p
          class="flex h-10 items-center justify-center bg-neutral-950 px-4 text-sm font-medium text-white sm:px-6 lg:px-8"
        >
          Din klubaftale
        </p>
        <p
        ...
        <div class="border-b border-gray-200">
          <div class="flex h-16 justify-between items-center">
            ...
            <div class="ml-4 flex lg:ml-0">
              <a href="#">
                <span class="sr-only">Macron Aarhus Store</span>
                <img class="h-16 w-auto" src="../assets/Udklip.JPG" alt="" />
              </a>
            </div>
