  ...
  <div class="bg-white">
    ...
    <header class="relative bg-white">
      <div class="top-header-flex">
        <p class="flex h-10 items-center justify-center bg-neutral-950 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">Din klubaftale</p>
        <p class="flex h-10 items-center justify-center bg-neutral-950 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">Fri fragt ved køb over 500 DKK</p>
        <p class="flex h-10 items-center justify-center bg-neutral-950 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">Hurtig levering</p>
      </div>
