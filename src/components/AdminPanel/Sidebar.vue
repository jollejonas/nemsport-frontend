...
<template>
  <div
    class="bg-gray-700 text-white w-64 space-y-6 px-2 py-2 absolute inset-y-0 left-0 md:relative md:-translate-x-0 -translate-x-full transition duration-200 ease-in-out"
  >
    <a href="#" class="flex items-center space-x-2 px-4">
      <svg
        ...
        width="160.000000pt"
        height="70.000000pt"
        viewBox="0 0 252.000000 81.000000"
      ...
      >
        ...
        >
          <path
            d="M140 962 l0 -402 100 0 100 0 0 266 c0 305 17 354 127 354 132 0 142
...
173 -464 102 -60 -31 -70 -30 -130 0 -45 23 -133 35 -290 41 l-225 7 0 -402z"
          />
          <path
            d="M1570 1342 c-90 -23 -146 -64 -179 -132 l-29 -60 91 -6 c53 -4 119 6
...
-69z"
          />
          <path
            d="M2300 1337 c-353 -104 -309 -726 56 -784 170 -27 404 109 404 236 0
31 -188 8 -235 -29 -149 -117 -283 8 -260 245 15 160 156 234 255 135 55 -55
246 -59 226 -5 -60 166 -260 257 -446 202z"
          />
          <path
            d="M3080 1341 c-224 -45 -260 -115 -260 -500 l0 -281 100 0 100 0 0 256
c0 283 10 312 114 331 60 11 232 167 215 194 -10 17 -185 17 -269 0z"
          />
          <path
            d="M4100 962 l0 -402 100 0 100 0 0 266 c0 305 17 354 127 354 132 0
142 -24 150 -338 l6 -282 100 0 101 0 -7 299 c-10 427 -62 483 -462 498 l-215
7 0 -402z"
          />
          <path
            d="M3452 1295 c-107 -61 -106 -69 39 -200 156 -140 149 -140 308 4 117
107 126 121 100 152 -80 96 -315 119 -447 44z m265 -61 l43 -47 -48 -45 c-54
-51 -105 -45 -160 16 -72 80 91 154 165 76z"
          />
          <path
            d="M3292 1144 c-114 -221 6 -518 237 -581 106 -29 108 -47 -40 299 -153
358 -156 362 -197 282z"
          />
          <path
            d="M3922 1155 c-10 -25 -68 -161 -130 -304 -133 -306 -134 -315 -49
-290 244 70 368 341 257 560 -47 92 -55 95 -78 34z"
          />
          <path
            d="M2383 375 c-59 -101 -67 -147 -19 -99 29 29 116 32 116 4 0 -11 23
...
-114 -65 -114 -101 50 -17 79 -40 69 -108 -50z"
          />
          <path
            d="M2789 405 c-7 -41 -17 -92 -23 -112 -7 -26 -2 -35 17 -29 15 5 30 27
...
67 -59 49 -12 -7 18 -1 53 13 79 36 67 13 110 -58 110 -54 0 -62 -8 -73 -75z"
          />
          <path
            d="M2973 405 c-18 -107 -16 -145 7 -145 11 0 20 18 20 40 0 27 13 40 40
...
85 75 29z"
          />
          <path
            d="M4711 415 c-9 -27 -51 -231 -51 -246 0 -5 36 -9 80 -9 58 0 80 8 80
...
7 11 29 20 49 20 20 0 42 14 48 30 9 24 -5 30 -68 30 -47 0 -84 -11 -88 -25z"
    ...
    <nav>
      <a
        href="#"
        class="flex items-center space-x-2 px-4 py-2 hover:bg-gray-800 rounded transition duration-200"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
      ...
      <div
        ...
        class="flex items-center space-x-2 px-4 py-2 hover:bg-gray-800 rounded transition duration-200 cursor-pointer"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-4 w-4"
        ...
        <span>Produkt håndtering</span>
      </div>
      <div
        :class="`transform transition-all duration-200 ${isDropdownOpen ? 'opacity-100 scale-100' : 'opacity-0 scale-95'} absolute bg-gray-700 text-white w-60`"
      >
        <router-link
          to="/admin/manage-base-products/"
          class="block px-4 py-1 hover:bg-gray-800 rounded transition duration-200"
          >Grund produkter</router-link
        >
        <router-link
        ...
        <router-link
          ...
          class="block px-4 py-1 hover:bg-gray-800 rounded transition duration-200"
          >Variationer</router-link
        >
        <router-link
          to="/admin/manage-materials/"
          class="block px-4 py-1 hover:bg-gray-800 rounded transition duration-200"
          >Materialer</router-link
        >
        <router-link
