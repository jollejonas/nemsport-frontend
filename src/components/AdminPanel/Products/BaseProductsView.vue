    ...
    <table class="table-auto mx-auto mt-14">
      <thead>
        <tr>
          ...
          <th class="border bg-gray-900 text-white border-gray-200 py-2 px-4">Status</th>
          <th class="border bg-gray-900 text-white border-gray-200 py-2 px-4">
            Status ved udsolgt
          </th>
      ...
      <tbody>
        <tr>
          ...
          <td class="border border-gray-200 py-2 px-4 text-center">Aktiv</td>
          <td class="border border-gray-200 py-2 px-4 text-center">Aktiv</td>
          ...
          <td class="border border-gray-200 py-2 px-4 text-center">100kr</td>
          <td class="border border-gray-200 py-2 px-4 text-center">Bomuld</td>
          <td class="border border-gray-200 py-2 px-4 text-center">Test</td>
          <td class="border border-gray-200 py-2 px-4 text-center">Stk</td>
          <td class="border border-gray-200 py-2 px-4 text-center">16-02-2024</td>
          <td class="border border-gray-200 py-2 px-4 text-center">18-02-2024</td>
